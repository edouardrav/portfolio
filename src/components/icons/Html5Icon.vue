...
<template>
  <svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    viewBox="-153.6 -153.6 819.20 819.20" enable-background="new 0 0 512 512" xml:space="preserve">
    <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(87.03999999999999,87.03999999999999), scale(0.66)">
      <path transform="translate(-153.6, -153.6), scale(51.2)" :fill="bgColor"
